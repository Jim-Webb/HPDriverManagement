#
# Module manifest for module 'PSGet_DriverManagement'
#
# Generated by: Jim Webb
#
...
ModuleVersion = '25.4.30.1'

# Supported PSEditions
# CompatiblePSEditions = @()

# ID used to uniquely identify this module
GUID = 'c78cd908-e16c-462f-8f9c-4170fe7d561d'

# Author of this module
Author = 'Jim Webb'

# Company or vendor of this module
CompanyName = 'Jim Webb'

# Copyright statement for this module
Copyright = '(c) 2025 Jim Webb . All rights reserved.'

# Description of the functionality provided by this module
Description = 'Module to assist with the management HP Drivers'
...
RequiredModules = @(@{ModuleName = 'HPCMSL' ; ModuleVersion = '1.8.1';})
...
AliasesToExport = @('Import-CMPSModule','Invoke-ModuleVersionCheck')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '## [25.4.30.1] - 2025-04-30

### Updated

- [Invoke-DM_HPRepositorySync] - Updated to capture the output of the repository cleanup command. The output was getting piped to the next cmdlet and   causing problems.
- [New-DM_HPDriverPack] - Updated to handle an exception generated by the HP cmdlet when it attempted to download a drive for PlatformID 8881.
